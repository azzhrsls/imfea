...
<html lang="en">
  ...
  <body>
      ...
      <div class="nav container">
        ...
        <div class="nav-menu" id="nav-menu">
          <ul class="nav-list">
            ...
            <li class="nav-item ">
              <a href="{{ route('courses.index') }}" class="nav-link">Pengurus</a>
            </li>
            @auth
              @if(auth()->user()->isAdmin())
                <li class="nav-item">
                  <a href="{{ route('admin.courses.index') }}" class="nav-link">Lainnya</a>
                </li> 
              @endif
            @endauth
          </ul>
    ...
    <footer class="footer section">
      ...
      <span class="footer-copy">Mahasiswa TI Polindra. All rights</span>
    </footer>
